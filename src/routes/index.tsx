	...
	return (
		<>
			<Head
				...
				description="Building self-hostable systems software. Go, C, and the web. Local-first, operator-friendly, relational data."
			/>
			<div className="home">
				<section className="hero">
					...
					<p className="stack">
						Most of it lives in <strong>Go</strong> and <strong>C</strong>, with{" "}
